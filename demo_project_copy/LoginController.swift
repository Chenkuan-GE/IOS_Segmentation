...
class LoginController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, LoginControllerDelegate {
    ...
    let pages: [Page] = {
        let firstPage = Page(title: "Enjoy the fun of Computer Vision", message: "You can find many interesting things through the image segmentation during daily life! Having fun!", imageName: "page1")
        
        let secondPage = Page(title: "Finding intersting things Around you", message: "Many things you might ignored would be clear at this sight", imageName: "page2")
        
        let thirdPage = Page(title: "Record everthing from life!", message: "record and save the images that took from you or your friends", imageName: "page3")
